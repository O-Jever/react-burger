...
import { BurgerConstructorFillingItem } from '../burger-constructor-filling-item';

import './styles.css';

export const BurgerConstructorFillings = () => {
    ...
    return (
        <div ref={dropTarget} className='burger-scrollbar burger-constructor-fillings mt-4 mb-4 pr-4'>
            {sortedFillings.length ? sortedFillings.map((filling) => 
                <BurgerConstructorFillingItem key={filling.uuid} filling={filling} />
